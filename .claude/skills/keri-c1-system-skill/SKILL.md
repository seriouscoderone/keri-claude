---
name: keri-c1-system
description: Design a human-facing KERI service within an existing ecosystem. Reads ecosystem.yaml from C0 to understand governance context, then guides through service definition including value proposition, user journeys, KERI requirements, and business model. Produces system.yaml and service-design.md. Invoke with /keri-c1-system.
command: /keri-c1-system
user_invocable: true
---
