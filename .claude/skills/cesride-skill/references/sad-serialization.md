...
> For CESR version strings, SAID algorithms, and counter code tables, see cesr-spec skill.
> For event types (ilks) and field labels, see keri-spec skill. For ACDC structure, see acdc-spec skill.
...
73 counter codes defined in `Counter::Codex` — see cesr-spec for full registry.
