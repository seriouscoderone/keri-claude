...
description: >
  ...
  error handling. Defers to cesr-spec/keri-spec/acdc-spec for protocol theory; focuses on
...
**Companion skills:** For CESR encoding theory and code tables, see **cesr-spec**. For KERI
event model and validation rules, see **keri-spec**. For ACDC credential structure and IPEX
protocol, see **acdc-spec**.
