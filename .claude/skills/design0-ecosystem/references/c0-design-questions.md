...
Question bank for the `/keri:design0-ecosystem` workflow. Each question probes a facet of the industry that maps to a specific KERI concept and populates a specific field in `ecosystem.yaml`.
