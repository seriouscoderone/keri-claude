...
| Skill | Defers to for |
|-------|--------------|
| **cesride-skill** | Individual primitive API (Verfer, Diger, Siger constructors, Matter/Indexer traits) |
| **cesr-spec** | Encoding theory, code table registry, SAID algorithm, composability rules |
| **keri-spec** | Event types, KEL rules, delegation, witness agreement, pre-rotation |
| **acdc-spec** | Credential structure, graduated disclosure, TEL registries |
